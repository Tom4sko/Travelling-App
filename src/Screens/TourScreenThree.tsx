  ...
  return (
      <View style={styles.container}>
        <View style={styles.imageContainer}>
          <Image source={require('../Images/cannoing.jpg')} style={styles.image} />
        </View>

        <View style={styles.wrapperHeader}>
          <Text style={styles.textHeader}>{cardInfo.names[2]}</Text>
          <TouchableOpacity>
        ...
        <View style={styles.wrapper}>
            ...
            <View>
                ...
                <Text style={styles.price}>{cardInfo.price[2]}</Text>
            </View>
        </View>

        <View style={styles.wrapperDescription}>
            <Text style={styles.textDescription}>Description</Text>
            <Text style={styles.paragraph}>{cardInfo.description[2]}</Text>
        </View>
